...
interface QoreAiAssistantProps {
  contextType?: string
  contextId?: string
...
export function QoreAiAssistant({
  ...
  initialMessage,
  onClose
}: QoreAiAssistantProps) {
  const [message, setMessage] = useState("")
  const [conversation, setConversation] = useState<{ role: string; content: string }[]>([
    {
      role: "assistant",
      content: initialMessage || "Hello! I'm your QoreAI assistant. How can I help optimize your operations today?"
    }
  ])
